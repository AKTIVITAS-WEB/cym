var jtab = {
  ...
  Strings : {
  	AboutDialog : '<html><head><title>AKTIVITAS WEB</title></head><body style=""><p style="">jTab version: {V}</p><p><a href="https://www.aktivitasweb.com" target="_blank">https://www.aktivitasweb.com</a></p><p><input type="button" class="close" value="OK" onClick="window.close()"/></p></body></html>'
  },
  Chords : {
